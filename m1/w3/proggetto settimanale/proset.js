...
var me = {              //creo la variabile e li applico le proprietà
    name: "Daniel",
    lastname: "Gherghisan",
    age: "24",
} 
...
function splitMe(str){
    ...
    let split = str.split(' ');     //con la varaibile split indichiamo la parte da cancellare dalla stringa e ridarrà in output gli elementi tra gli spazi, quindi in questo caso le parole della frase   
    return split;
    }
...
function deleteOne (c, boolean){                //dichiariamo una function con i parametri c e boolean
    ...
    if( boolean ){
        return c.slice(1);            //con un if mettiamo la condizione che se il boolean è true allora uscirà un determinato risultato, se la condizione non verrà rispettata allora si avverà l'else
...
function whatDayIsIt (){
    ...
    var day = new Date();       //usiamo il metodo new Date per farci attaccare alla data del browser, cosi usl programma uscirà la data legata alla time zone
    var thisDay = day.getDay();  //darà il giorno contato da 1 a 7 in base alla settimana, oggi venerdì uscirà 5
    return thisDay;
}
...
console.log(howManyDays("11/11/2022", "11/6/2022"));  // uscirà un valore di giorni tra il 11 di novembre e il 6 di novembre
